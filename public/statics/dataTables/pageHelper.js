var PageHelper = function () {
    ...
    var language = {
        ...
        processing: `<div class="row">
                        <div class="spinner-border text-primary ms-auto me-auto" role="status"></div>
                    </div>`,
        lengthMenu: "_MENU_",
    ...
    var dom = "tr<'row align-items-center justify-content-end page-bg' <'col-auto me-2'i><'col-auto'l><'col-auto'p>>";
